...
class ABlock(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=1.2, area=1):
        ...
        print(f"Params for AAttn: dim={dim}, num_heads={num_heads}, area={area}")
        self.attn = AAttn(dim, num_heads=num_heads, area=area)

        mlp_hidden_dim = int(dim * mlp_ratio)
        print(f"Params for first Conv: in_channels={dim}, out_channels={mlp_hidden_dim}, kernel_size=1")
        print(f"Params for second Conv: in_channels={mlp_hidden_dim}, out_channels={dim}, kernel_size=1, act=False")
